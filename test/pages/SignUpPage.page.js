...
const telnyxsTermsLinkButton = 'label[for="terms_and_conditions"]>span>a:first-child'
const privacyPolicyLinkButton = 'label[for="terms_and_conditions"]>span>a:nth-child(2)'
